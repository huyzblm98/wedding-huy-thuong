    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-wedding-blue via-background to-wedding-rose-light">
      ...
      <div className={`relative z-10 text-center px-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="mb-6 animate-fade-in max-w-4xl mx-auto px-4" style={{ marginTop: '15%', animationDelay: '0.3s' }}>
          <h1 className="font-script text-5xl sm:text-7xl md:text-8xl lg:text-9xl text-wedding-rose mb-2 -translate-x-[15%] sm:-translate-x-[25%] md:-translate-x-[40%] lg:-translate-x-[50%] animate-float" style={{ textShadow: '0 0 30px rgba(255, 105, 135, 0.6), 0 0 60px rgba(255, 105, 135, 0.4)' }}>
            Hoài Thương
          </h1>
          ...
          <h1 className="font-script text-5xl sm:text-7xl md:text-8xl lg:text-9xl text-wedding-rose translate-x-[15%] sm:translate-x-[25%] md:translate-x-[40%] lg:translate-x-[50%] animate-float" style={{ textShadow: '0 0 30px rgba(255, 105, 135, 0.6), 0 0 60px rgba(255, 105, 135, 0.4)', animationDelay: '1s' }}>
            Quang Huy
          </h1>
        </div>
